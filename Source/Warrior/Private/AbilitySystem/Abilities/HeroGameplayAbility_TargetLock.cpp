...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	{
		NewTargetToLock = GetNearestTargetFromAvilableActors(ActorsOnLeft);
	}
	else
	{
		NewTargetToLock = GetNearestTargetFromAvilableActors(ActorsOnRight);
	}
...
void UHeroGameplayAbility_TargetLock::TryLockOnTarget()
{
	...
	CurrentLockedActor = GetNearestTargetFromAvilableActors(AvailableActorsToLock);
...
AActor* UHeroGameplayAbility_TargetLock::GetNearestTargetFromAvilableActors(const TArray<AActor*>& InAvailableActors)
{
...
void UHeroGameplayAbility_TargetLock::InitTargetLockMovement()
{
	...
	GetHeroCharacterFromActorInfo()->GetCharacterMovement()->MaxWalkSpeed = TargetLockWalkSpeed;
}
