...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_Toogleable, "InputTag.Toogleable");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_Toogleable_TargetLock, "InputTag.Toogleable.TargetLock");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_Toogleable_Rage, "InputTag.Toogleable.Rage");
